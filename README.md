...
[![Release](https://img.shields.io/badge/Release-v0.3.7-08C)](https://github.com/skaldlab/muninn/releases/tag/v0.3.7)
...
```bash
go install github.com/skaldlab/muninn@v0.3.7
```
...
```bash
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.7 \
  --format '{{ json .SBOM }}'
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.7 \
