...
```bash
go install github.com/skaldlab/muninn@v0.3.6
```
...
```bash
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.6 \
  --format '{{ json .SBOM }}'
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.6 \
